      ...
      <div className='flex flex-col items-center bg-gray-100 dark:bg-gray-800 p-9 md:p-16 2xl:px-28 group '>
        ...
        <div className='flex flex-col lg:flex-row'>
          <div className='mb-6 lg:basis-1/2 lg:pr-6 lg:pt-2'>
            <p className='mb-3 text-justify dark:text-gray-200'>Having worked as a teacher for the last 7 years I am seeking to change to a career as a software developer.</p>
            <p className='mb-3 text-justify dark:text-gray-200'>As a passionate and versatile software engineer, my journey has taken me from the classroom to coding, blending the precision and problem-solving skills honed as a teacher with a profound love for technology.</p>
            <p className='hidden text-justify md:block dark:text-gray-200'>Outside of software development, my interests in video games and cooking fuel my creativity, fostering a holistic approach to problem-solving. I am eager to contribute my diverse skills and enthusiasm for technology to a dynamic software engineering role, where I can make meaningful contributions and continue my professional growth.</p>
          </div>
          <div className='flex flex-wrap justify-center lg:basis-1/2'>
            {
              skills.map(({ name, image }, index) => {
                return (
                  <div key={index} className='flex flex-col items-center justify-center w-20 h-20 p-4 m-2 transition-all duration-700 ease-out bg-gray-200 rounded shadow-md dark:bg-gray-600 dark:text-gray-200 odd:hover:shadow-yellow-500 even:hover:shadow-red-500'>
