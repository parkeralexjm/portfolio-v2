...
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
  ...
  return (
    <header className="transition-colors duration-300 bg-gray-100 md:flex dark:bg-gray-800">
      <div className="container px-5 py-3 mx-auto md:flex md:justify-between">
        <nav className="flex items-center justify-between">
          <div className="flex items-center">
            <button
              className="flex items-center w-10 h-5 ml-1 mr-5 transition duration-300 bg-gray-100 rounded-full shadow dark:bg-gray-200 focus:outline-none"
              onClick={handleClick}>
              <div
                id="switch-toggle"
          ...
          <div className="flex items-center">
            <div>
              <button type="button" className="relative z-20 block text-gray-800 dark:text-gray-200 md:hidden" onClick={handleOpen}>
        ...
        <div className={"transition-colors duration-300 z-10 text-right absolute right-0 px-2 py-2 rounded shadow-xl bg-gray-100 dark:bg-gray-800 md:flex md:shadow-none md:rounded-none md:p-0 md:static" + (open ? ' block' : ' hidden')}>
